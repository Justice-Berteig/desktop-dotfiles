...
local dark_red = hsl("#7D3347")
local dark_green = hsl("#587338")
local dark_yellow = hsl("#946433")
local dark_blue = hsl("#405E87")
local dark_purple = hsl("#824979")
local dark_cyan = hsl("#2D6963")
local bright_red = hsl("#B5545F")
local bright_green = hsl("#A8BA5A")
local bright_yellow = hsl("#E8AD5A")
local bright_blue = hsl("#7A9DBF")
local bright_purple = hsl("#C27DC0")
local bright_cyan = hsl("#58AB84")
local bg0 = hsl("#080A09")
local bg1 = hsl("#191610")
local bg2 = hsl("#2A2216")
local bg3 = hsl("#3B2D1D")
local bg4 = hsl("#4C3923")
local bg5 = hsl("#5D452A")
local fg0 = hsl("#FAF3EC")
local fg1 = hsl("#EDE8D0")
local fg2 = hsl("#E1DDB4")
local fg3 = hsl("#D4D197")
local fg4 = hsl("#C8C67B")
local fg5 = hsl("#BBBB5F")
